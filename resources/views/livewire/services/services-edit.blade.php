<div class="max-w-4xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            ...
            <p class="text-slate-500 mt-1">Perbarui informasi layanan {{ $service->name }}</p>
        </div>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        <div class="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-2">
                    ...
                    <input wire:model="code" type="text" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all">
                ...
                <div class="space-y-2">
                    ...
                    <select wire:model="service_type" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all">
                    ...
                    @error('service_type') <p class="text-xs text-rose-500 mt-1">{{ $message }}</p> @enderror
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex items-center mt-2">
                        <input wire:model="is_active" type="checkbox" class="w-5 h-5 text-indigo-600 bg-white border-slate-300 rounded-lg focus:ring-indigo-500">
                        <span class="ml-2 text-sm text-slate-700">Layanan Aktif</span>
                    </div>
                </div>
            </div>
        ...
        <div class="flex justify-end gap-3">
            ...
            <button type="submit" class="px-8 py-4 rounded-xl text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-700 shadow-lg shadow-indigo-500/25 transition-all" wire:loading.attr="disabled">
                <span wire:loading.remove><i class="fa-solid fa-save mr-2"></i> Perbarui Layanan</span>
