<div class="space-y-8">
    <div class="flex items-center gap-4">
        <a href="{{ route('patients.show', $patient) }}" class="p-2 bg-white border border-slate-200 rounded-xl text-slate-500 hover:text-indigo-600 transition-colors">
            <i class="fa-solid fa-arrow-left"></i>
        </a>
        <div>
            <h1 class="text-3xl font-bold text-slate-900">Edit Data Pasien</h1>
            <p class="text-slate-500 mt-1">Perbarui informasi profil dan medis {{ $name }}.</p>
        </div>
    </div>
    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <div class="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-2">
                    ...
                    <input wire:model="nik" type="text" maxlength="16" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all">
            ...
            <div class="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea wire:model="allergies" rows="2" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all"></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-2">
                            ...
                            <input wire:model="phone" type="tel" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all">
                        </div>
                        <div class="space-y-2">
                            <label class="text-sm font-semibold text-slate-700">Kontak Darurat</label>
                            <input wire:model="emergency_contact" type="text" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all">
                        </div>
                    </div>
                    <div class="space-y-2">
                        <label class="text-sm font-semibold text-slate-700">Alamat Lengkap</label>
                        <textarea wire:model="address" rows="2" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all"></textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-end gap-3">
            <a href="{{ route('patients.show', $patient) }}" class="px-8 py-4 rounded-xl text-sm font-bold text-slate-600 bg-white border border-slate-200 hover:bg-slate-50 transition-colors">Batal</a>
            <button type="submit" class="px-8 py-4 rounded-xl text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-700 shadow-lg shadow-indigo-500/25 transition-all">
                <i class="fa-solid fa-save mr-2"></i> Perbarui Pasien
            </button>
        </div>
    </form>
</div>
