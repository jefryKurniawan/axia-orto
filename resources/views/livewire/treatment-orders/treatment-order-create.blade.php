<div class="space-y-8">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-3xl font-bold text-slate-900">Buat Pesanan Baru</h1>
            <p class="text-slate-500 mt-1">Input detail pesanan alat orthotic prosthetic pasien.</p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
                    ...
                    <div class="space-y-6">
                        <div class="relative">
                            <label class="text-sm font-semibold text-slate-700">Pilih Pasien <span class="text-rose-500">*</span></label>
                ...
                <div class="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-72 bg-white border border-slate-200 rounded-2xl shadow-xl z-50 overflow-hidden">
            ...
            <div class="space-y-8">
                <div class="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
                    ...
                    <div class="space-y-6">
                        <div class="space-y-2">
                            <label class="text-sm font-semibold text-slate-700">Status Awal</label>
                ...
                <div class="bg-indigo-600 rounded-3xl p-8 text-white shadow-xl shadow-indigo-500/20">
                    ...
                    <p class="text-indigo-100 text-xs mb-6">Pastikan data sudah benar sebelum menyimpan pesanan.</p>
                    
                    <div class="space-y-4 mb-8">
                        <div class="flex justify-between text-sm">
                            <span class="text-indigo-200">Total Tagihan</span>
                        ...
                        <div class="border-t border-white/10 pt-4 flex justify-between">
                            ...
                            <span class="text-xl font-bold">Rp {{ number_format($total_amount, 0, ',', '.') }}</span>
                        </div>
                    </div>
