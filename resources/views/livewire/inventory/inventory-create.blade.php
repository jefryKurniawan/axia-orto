<div class="space-y-8">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-3xl font-bold text-slate-900">Tambah Item Inventori</h1>
            <p class="text-slate-500 mt-1">Daftarkan barang atau material baru ke dalam stok.</p>
        </div>
    </div>
    ...
    <form wire:submit="save" class="space-y-8">
        <div class="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-2">
                    ...
                    <input wire:model="name" type="text" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all" placeholder="Masukkan nama barang...">
                ...
                <div class="space-y-2">
                    ...
                    <input wire:model="unit" type="text" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all" placeholder="pcs, kg, m, dsb.">
        ...
        <div class="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
            <div class="space-y-2">
                ...
                <textarea wire:model="description" rows="3" class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all" placeholder="Catatan tambahan mengenai barang ini..."></textarea>
            </div>
        </div>
