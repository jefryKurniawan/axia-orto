...
<head>
  ...
  <title>Ecommerce Dashboard - Cleopatra</title>
</head>
        ...
        <div class="dropdown relative md:static">
          ...
          <div class="text-gray-500 menu hidden md:mt-10 md:w-full rounded bg-white shadow-md absolute z-20 right-0 w-40 mt-5 py-2 animated faster">
            ...
            <form method="POST" action="{{ route('logout') }}">
              @csrf
              <button type="submit" class="w-full text-left px-4 py-2 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 hover:text-gray-900 transition-all duration-300 ease-in-out">
...
<div class="h-screen flex flex-row flex-wrap">
  ...
  <div id="sideBar" class="relative flex flex-col flex-wrap bg-white border-r border-gray-300 p-6 flex-none w-64 md:-ml-64 md:fixed md:top-0 md:z-30 md:h-screen md:shadow-xl animated faster">
    ...
    <div class="flex flex-col">
      ...
      <!-- link -->
      <a href="{{ route('cleopatra.dashboard') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
      ...
      <!-- link -->
      <a href="{{ route('index-1') }}" class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
        ...
        <div class="card-body h-full flex flex-col justify-between">
          ...
          <div class="flex flex-row mt-10 items-end">
            ...
            <div class="flex-1 ml-10 w-32 h-32 lg:w-auto lg:h-auto overflow-hidden">
              <img class="object-cover" src="{{ asset('images/congrats.svg') }}">
            </div>
          </div>
        </div>
      </div>
            ...
            <tbody>
              <tr class="">
                <td class="py-4 text-sm text-gray-600 flex flex-row items-center text-left">
                  <div class="w-8 h-8 overflow-hidden mr-3">
                    <img src="{{ asset('images/sneakers.svg') }}" class="object-cover">
                  </div>
                  Sneakers and Tennis 
                </td>
              ...
              <tr class="">
                <td class="py-4 text-sm text-gray-600 flex flex-row items-center">
                  <div class="w-8 h-8 overflow-hidden mr-3">
                    <img src="{{ asset('images/socks.svg') }}" class="object-cover">
                  </div>
              ...
              <tr class="">
                <td class="py-4 text-sm text-gray-600 flex flex-row items-center">
                  <div class="w-8 h-8 overflow-hidden mr-3">
                    <img src="{{ asset('images/soccer.svg') }}" class="object-cover">
                  </div>
                  Adidas Soccer Ball
                </td>
                <td class="py-4 text-xs text-gray-600">$ <span class="num-2"></span></td>
              ...
              <tr class="">
                <td class="py-4 text-sm text-gray-600 flex flex-row items-center">
                  <div class="w-8 h-8 overflow-hidden mr-3">
                    <img src="{{ asset('images/food.svg') }}" class="object-cover">
                  </div>
            ...
            <tbody class="text-left text-gray-600">
              <tr>
                <th class="w-1/2 mb-4 text-xs font-extrabold tracking-wider flex flex-row items-center w-full">
                  <div class="w-8 h-8 overflow-hidden rounded-full">
                    <img src="{{ asset('images/user2.jpg') }}" class="object-cover">
                  </div>
              ...
              <tr>
                <th class="w-1/2 mb-4 text-xs font-extrabold tracking-wider flex flex-row items-center w-full">
                  <div class="w-8 h-8 overflow-hidden rounded-full">
                    <img src="{{ asset('images/user3.jpg') }}" class="object-cover">
                  </div>
                  <p class="ml-3 name-1">user name</p>                    
                </th>
                <th class="w-1/4 mb-4 text-xs font-extrabold tracking-wider text-right">Nike Sport</th>
