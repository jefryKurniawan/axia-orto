<html lang="en">
  <head>
    <title>@yield('title', 'Axia Ortotik')</title>
    <meta charset="utf-8"/>
    ...
    {{-- KODE 1: HEADER/NAVBAR GLOBAL --}}
    <section class="relative bg-teal-900" x-data="{ mobileNavOpen: false }"> 

        {{-- 1. NAVBAR (Header Utama) --}}
        <nav class="py-6 relative z-30"> 
            <div class="container mx-auto px-4">
                <div class="relative flex items-center justify-between">
                    <a class="inline-block" href="#!"><img class="h-8" src="images/logo-white.svg" alt=""/></a>
                    ...
                    <div class="flex items-center justify-end relative z-40"> 
        ...
        <div class="relative pt-18 pb-24 sm:pb-32 lg:pt-36 lg:pb-62 z-10">
            <div class="container mx-auto px-4 relative">
                <div class="max-w-lg xl:max-w-xl mx-auto text-center">
                    ...
                    <p class="max-w-md xl:max-w-none text-lg text-white opacity-80 mb-10">Our commitment to green energy is paving the way for a cleaner, healthier planet. Join us on a journey towards a future where clean, renewable energy sources transform the way we power our lives.</p>
                    <a class="inline-flex py-4 px-6 items-center justify-center text-lg font-medium text-teal-900 border border-lime-500 hover:border-white bg-lime-500 hover:bg-white rounded-full transition duration-200" href="#!">See our solutions</a>
                </div>
            </div>
        </div>
        
        {{-- 3. MOBILE MENU OVERLAY (DENGAN POINTER EVENTS FIX) --}}
        <div class="hidden fixed top-0 left-0 bottom-0 w-full xs:w-5/6 xs:max-w-md z-50 lg:hidden" 
            :class="{
                'block': mobileNavOpen, 
                'hidden': !mobileNavOpen,
                // LOGIKA POINTER-EVENTS YANG MEMPERBAIKI KLIK DI DESKTOP/MOBILE
                'pointer-events-auto': mobileNavOpen,
                'pointer-events-none': !mobileNavOpen 
            }">
            ...
            <nav class="relative flex flex-col py-7 px-10 w-full h-full bg-white overflow-y-auto">
                ...
                {{-- Konten Mobile Menu (Harus memiliki tombol login yang berfungsi juga) --}}
                <div class="flex items-center justify-between">
                    <a class="inline-block" href="#!"><img class="h-8" src="fauna-assets/logos/sign-logo-flow.svg" alt=""/></a>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        <a class="inline-block mr-4" href="#!"><svg width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">...</svg></a>                  
                        <a class="inline-block mr-4" href="#!"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">...</svg></a>                  
                        <a class="inline-block" href="#!"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">...</svg></a>
                    </div>
                </div>
            </nav>
        </div>
        
        {{-- 4. GAMBAR LATAR BELAKANG (HARUS DITEMPATKAN DI AKHIR DENGAN Z-INDEX TERENDAH) --}}
        <img class="absolute top-0 left-0 w-full h-full z-0" src="{{ asset('fauna-assets/headers/bg-waves.png') }}" alt=""/>
    ...
    <div class="hidden fixed top-0 left-0 bottom-0 w-full xs:w-5/6 xs:max-w-md z-50 lg:hidden" 
        ...
        {{-- KODE 2: TEMPAT KONTEN UNIK --}}
        @yield('content') 

        {{-- KODE 3: FOOTER GLOBAL (DARI BARIS 408) --}}
